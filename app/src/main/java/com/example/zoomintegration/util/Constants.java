package com.example.zoomintegration.util;
...
// Change it to your APP Key
    public final static String APP_KEY = "0ecQqSY4XTMHUwHpmo71MBUH31kHnflHBQki";

    // Change it to your APP Secret
    public final static String APP_SECRET = "g7rESsfUuk1XAPULyhS0ZyWFKXPN4dPrNfo7";
